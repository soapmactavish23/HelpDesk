...
public class UserController {
	...
	public ResponseEntity<Response<User>> create(HttpServletResponse request, @RequestBody User user, BindingResult result) {
	...
	@PutMapping
	@PreAuthorize("hasAnyRole('ADMIN')")
	public ResponseEntity<Response<User>> update(HttpServletResponse request, @RequestBody User user, BindingResult result) {
		Response<User> response = new Response<User>();
		try {
